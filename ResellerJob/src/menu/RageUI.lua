...
print("")
print("^1Job Quartier RageUII^0")
print("^4https://discord.gg/fivedev^0")
print("")
...
----- Template Job En RageUI -----
----- Pour vous aide ah faire vos Job -----
----- By PaBLO#7402 -----
----- RR-Développement : https://discord.gg/9NSRKGu34z -----
----- Chaine YouTube : https://www.youtube.com/channel/UCnv294eFDcFk8v2hln-VUsQ -----
